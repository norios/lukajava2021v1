public class E10_5 {
    public static void main(String [] args){
        ...
        System.out.println("age" + "\t" + "gender" + "\t" + "a" + "\t" + "b" + "\t" + "c" + "\t" + "d" + "\t" + "e" + "\t" + "total" + "\t" + "average");
        int j = 0;
        Student[] s = new Student[data.length];
        ...
        for(int i=0; i< data.length; i++){           
			...
			for(int i2=0; i2<rowsdata.length; i2++){
                if (i2 == 0){
                    ...
                    s[j].gender = rowsdata[i2].replace("男性","male").replace("女性","female");
                } else if (i2==2){
                    s[j].score1 = Integer.parseInt(rowsdata[i2]);
                } else if (i2==3){
                    s[j].score2 = Integer.parseInt(rowsdata[i2]);
                } else if (i2==4){
                    s[j].score3 = Integer.parseInt(rowsdata[i2]);
                } else if (i2==5){
                    s[j].score4 = Integer.parseInt(rowsdata[i2]);
                } else if (i2==6){
                    s[j].score5 = Integer.parseInt(rowsdata[i2]);
                } 
                s[j].total = s[j].score1 + s[j].score2 + s[j].score3 + s[j].score4 + s[j].score5 ;
                s[j].average  =  (double)s[j].total  / 5;
				
			}		
            System.out.println(s[j].age + "\t" + s[j].gender + "\t" + s[j].score1 + "\t" + s[j].score2 + "\t" + s[j].score3 + "\t" + s[j].score4 + "\t" + s[j].score5 + "\t" + s[j].total + "\t" + s[j].average);                
            j++;
